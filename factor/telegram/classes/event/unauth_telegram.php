...
namespace factor_telegram\event;
...
class unauth_telegram extends \core\event\base {
    /**
     ...
     */
    public static function unauth_telegram_event($user, $ip, $useragent) {
    ...
    public function get_description() {
        return "The user with id '{$this->other['userid']}' made an unauthorised login attempt using telegram verification from
    ...
    public static function get_name() {
        return get_string('event:unauthtelegram', 'factor_telegram');
    }
}
