...
$enabled = new checkbox('factor_webauthn/enabled',
...
$settings->add(new text('factor_webauthn/weight',
...
$settings->add(new select_multiple('factor_webauthn/authenticatortypes',
...
$settings->add(new select('factor_webauthn/userverification',
