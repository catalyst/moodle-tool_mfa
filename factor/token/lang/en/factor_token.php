...
$string['settings:expiry'] = 'Administrator trust duration';
$string['settings:expiry_help'] = 'The duration an administrator device is trusted before requiring a new MFA authentication. This allows tighter restrictions on site administrators, or no trust.';
