...
$settings->add(new core\setting\type\checkbox(
    'factor_grace/forcesetup',
    new lang_string('settings:forcesetup', 'factor_grace'),
    new lang_string('settings:forcesetup_help', 'factor_grace'),
    0
));

$settings->add(new core\setting\type\duration(
    'factor_grace/graceperiod',
    new lang_string('settings:graceperiod', 'factor_grace'),
    new lang_string('settings:graceperiod_help', 'factor_grace'),
    '604800'
));
...
$settings->add(new core\setting\type\select_multiple(
    'factor_grace/ignorelist',
    new lang_string('settings:ignorelist', 'factor_grace'),
    new lang_string('settings:ignorelist_help', 'factor_grace'),
    [],
    $gracefactors
));

$settings->add(new core\setting\type\editor_html(
    'factor_grace/customwarning',
    new lang_string('settings:customwarning', 'factor_grace'),
    new lang_string('settings:customwarning_help', 'factor_grace'),
    '',
    PARAM_RAW
));
